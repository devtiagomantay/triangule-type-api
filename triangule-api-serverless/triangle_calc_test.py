...
def test_calculate_triangle_type():
	...
	assert calculate_triangle_type([9,9,9]) == "equilateral"
	assert calculate_triangle_type([1.1, 1.2, 1.1]) == "isosceles"
	assert calculate_triangle_type([1, 7, 9]) == "scalene"
...
def test_triangle_is_triangle_isosceles():
	...
	assert is_triangle_isosceles([1, 1.9, 1.5]) is False
	assert is_triangle_isosceles([1, 7, 9]) is False
